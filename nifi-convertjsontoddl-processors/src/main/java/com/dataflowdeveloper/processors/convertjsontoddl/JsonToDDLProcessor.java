...
@SeeAlso({})
@ReadsAttributes({@ReadsAttribute(attribute="tableType", description="What type of table:   hive, mysql, oracle, postgresql, phoenix")})
...
public class JsonToDDLProcessor extends AbstractProcessor {
    ...
    public static final PropertyDescriptor MY_PROPERTY = new PropertyDescriptor
            .Builder().name("TABLE_TYPE")
            .displayName("Table Type")
            .description("What type of table:   hive, mysql, oracle, postgresql, phoenix")
            .required(false)
